...
class AddValueJenisCabangBranchInCabangsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            $table->string('sub_branch_unit')->nullable()->after('id');
        });
        ...
        Schema::table('model_has_permissions', function (Blueprint $table) {
            $table->string('sub_branch_unit')->nullable()->after('permission_id');
        });
        Schema::table('model_has_roles', function (Blueprint $table) {
            $table->string('sub_branch_unit')->nullable()->after('role_id');
        });
