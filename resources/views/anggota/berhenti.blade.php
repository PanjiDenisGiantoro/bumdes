...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
            <div class="card ">
                <h5 style="margin-left: 10px;margin-top: 10px">{{ __('Pemberhentian Anggota') }}</h5>

                <form method="POST" id="anggota_form" class="form-horizontal" action="{{ route('anggota.update_berhenti',$dataanggota->id) }}"enctype="multipart/form-data">
...
@enderror
            ...
            <div class="card-footer text-center">
                {{--                button approve--}}
                <button type="submit" class="btn btn-success" id="btn_approve">Setuju</button>
                <a href="{{ route('anggota.index') }}" class="btn btn-warning">{{ __('Menolak') }}</a>
