                ...
                <form method="POST" class="form-horizontal" action="{{ route('biaya.store') }}">
                    ...
                    <div class="card-body">
                        <div class="form-group clearfix">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="control-label form-label" for="anggota_id">Nama Transaksi</label>
                                </div>
                                <div class="col-md-3">
                                    <select name="anggota_id" id="anggota_id" class="form-control select2" readonly>
                                        <option value="">Pilih Anggota</option>
                                        @foreach($anggota as $item)
                                            <option value="{{ $item->id }}"@if(!empty($jurnal_keuangan) ? $item->id == $jurnal_keuangan->anggota_id : '')selected @endif>{{ $item->nama_pemohon }}</option>
                                        @endforeach
                                    </select>
                                    @error('date')
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select name="jenis_transaksi" id="jenis_transaksi" class="form-control" disabled>
                                        <option value="">Pilih</option>
                                        <option data-biaya="1" value="{{$pemetaan->biaya_tunai}}" @if(!empty($jurnal_keuangan->jenis_transaksi) ? $jurnal_keuangan->jenis_transaksi == $pemetaan->biaya_tunai : '')selected @endif >Tunai</option>
                                        <option data-biaya="2" value="{{$pemetaan->biaya_non_tunai}}" @if(!empty($jurnal_keuangan->jenis_transaksi) ? $jurnal_keuangan->jenis_transaksi == $pemetaan->biaya_non_tunai : '')selected @endif>Non Tunai</option>
                                    </select>
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="col-md-3">
                                ...
                                <input disabled type="text" name="nominal" class="form-control" value="{{ old('nominal',number_format($jurnal_keuangan->nominal) ?? null) }}">
                                @else
                                    <input
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select name="akun" id="akun" class="form-control select2"disabled>
                                        <option>Pilih</option>
