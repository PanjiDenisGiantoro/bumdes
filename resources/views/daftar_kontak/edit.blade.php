...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Informasi Tambah Kontak') }}">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
            <div class="card border-0 m-b-20">
                ...
                <form method="POST" class="form-horizontal" action="{{ route('daftar_kontak.update', [$daftar_kontak->id])}}">
                                        ...
                                        <div class="col-md-3">
                                            <select name="id_tipe_kontak" class="form-control select2" data-placeholder="{{ __('Pilih Tipe Kontak') }}">
                                                ...
                                                @foreach ($TipeKontak as $id => $name)
                                                    <option value="{{$id}}"@if($id == $daftar_kontak->id_tipe_kontak ??'')selected @endif>{{$name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
...
@enderror
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select id="gl_hutang" name="gl_hutang" class="form-control select2" data-placeholder="{{ __('Pilih Akun Hutang') }}">
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="control-label form-label" for="gl_piutang">{{ __('GL Piutang') }}</label>
                                </div>
                                <div class="col-md-9">
                                    <select id="gl_piutang" name="gl_piutang" class="form-control select2" data-placeholder="{{ __('Pilih GL Piutang') }}">
                                        <option value="">{{ __('Pilih GL Piutang') }}</option>
                                    </select>
                                </div>
