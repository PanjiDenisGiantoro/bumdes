                ...
                <form method="POST" class="form-horizontal" action="{{ !empty($daftar_pembiayaan->id) ? route('daftar_pembiayaan.update', [$daftar_pembiayaan->id]) : route('daftar_pembiayaan.store') }}"enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <!-- <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label class="control-label form-label" for="hasil_pengajuan">{{ __('Status Pengajuan') }}<span class="text-danger">*</span></label>

                                        </div>
                                        <div class="col-md-4">
                                            <select name="hasil_pengajuan" id="hasil_pengajuan" class="form-control">
                                                <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group mb-3">
                                                ...
                                                id="plafon_disetujui_value"
                                                name="plafon_disetujui_value"
                                                aria-label="Amount (to the nearest dollar)">
                                            </div>
                                            <input
                                                hidden
                                                value="{{$daftar_pembiayaan->plafon_disetujui ?? ''}}"
                                                id="plafon_disetujui"
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label class="control-label form-label" for="angsuran_perbulan">{{ __('Angsuran Perbulan') }}
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                ...
                                                style="text-align: right;"
                                                id="angsuran_perbulan_value"
                                                name="angsuran_perbulan_value"
                                                aria-label="Amount (to the nearest dollar)">
                                            </div>
                                            <input
                                                hidden
                                                value="{{$daftar_pembiayaan->angsuran_perbulan ?? ''}}"
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label" for="kwitansi">{{ __('Upload Kwitansi') }}</label>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="custom-file">
                                        <input type="hidden" name="exists_file_gambar" id="exists_file_gambar" value="{{$bukti[0] ?? ''}}">

                                        <input type="file" class="custom-file-input" name="filebukti"onchange="showPreview5(event);">
                                        <label class="custom-file-label"  id="kwitansi_label">{{ isset($buktianalisa[0]) ?  str_replace("bukti/$daftar_pembiayaan->id/", '', $bukti[0]) : 'Upload Gambar Kwitansi' }}</label>
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <label class="form-label" for="file_ktp">{{ __('Upload Gambar Analisa Keuangan') }}</label>
                                </div>
                                <div class="col-md-3">
                                    <div class="custom-file">
                                        <input type="hidden" name="exists_file_gambar1" id="exists_file_gambar1" value="{{$buktianalisa[0] ?? ''}}">

                                        <input type="file" class="custom-file-input" name="filebukti2"onchange="showPreview6(event);">
                                        <label class="custom-file-label" id="analisa_label">{{ isset($buktianalisa[0]) ?  str_replace("buktianalisa/$daftar_pembiayaan->id/", '', $buktianalisa[0]) : 'Upload Gambar Analisa' }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="data-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="btn btn-danger  fa fa-trash" onclick="deleteGambar2()"></button>
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select name="usaha" id="usaha" class="form-control">
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input
                                        hidden
                                        value="{{$daftar_pembiayaan->omset_harian ?? ''}}"
                                        id="omset_harian"
                                        name="omset_harian"
                                        type="text"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input
                                        value="{{$daftar_pembiayaan->pengeluaran ?? ''}}"
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input
                                        value="{{$daftar_pembiayaan->catatan ?? ''}}"

                                        id="catatan"
                                        name="catatan"
                                        type="text"
                                        @class(['required', 'form-control', 'is-invalid' => $errors->has('catatan')])
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" readonly id="bumdes"  value="{{$daftar_pembiayaan->anggota->bumdes ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <br>
...
@push('scripts')
    ...
    <script>
        ...
        $('#angsuran_perbulan_value').on('keyup',function(){
            $('#angsuran_perbulan_value').mask("#,##0", {reverse: true});
            test_value = $(this).val().replace(/[^0-9]+/g, "");
            $('#angsuran_perbulan').val(test_value)
        })
        ...
        $('#plafon_disetujui_value').on('keyup',function(){
            $('#plafon_disetujui_value').mask("#,##0", {reverse: true});
            test_value = $(this).val().replace(/[^0-9]+/g, "");
            $('#plafon_disetujui').val(test_value)
        })
        ...
        function showPreview5(event){
            if(event.target.files.length > 0){
                ...
                var preview = document.getElementById("gambar5");
                document.getElementById('kwitansi_label').innerHTML = event.target.files[0].name
                preview.src = src;
        ...
        function showPreview6(event){
            if(event.target.files.length > 0){
                var src = URL.createObjectURL(event.target.files[0]);
                var preview = document.getElementById("gambar6");
                document.getElementById('analisa_label').innerHTML = event.target.files[0].name
                preview.src = src;
                preview.style.display = "block";
            }
        }
        function deleteGambar() {
            var preview = document.getElementById("gambar5");
            document.getElementById('kwitansi_label').innerHTML = "Pilih File"
            preview.src = '';
        ...
        function deleteGambar2() {
            var preview = document.getElementById("gambar6");
            document.getElementById('analisa_label').innerHTML = "Pilih File"
            preview.src = '';
            document.getElementById('exists_file_gambar1').value = ''
        }
