...
{{--        </li>--}}
{{--        <li class="breadcrumb-item">--}}
{{--            <a href="{{ route('daftar_produk.index') }}">{{ __('Daftar Produk') }}</a>--}}
{{--        </li>--}}
{{--        <li class="breadcrumb-item">--}}
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
            <div class="card border-0 m-b-20">
                <h5 class="card-header">{{ __('Tambah Produk') }}</h5>

                <form method="POST" class="form-horizontal" id="produk_form" action="{{ !empty($daftar_produk->id) ? route('daftar_produk.update', [$daftar_produk]) : route('daftar_produk.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="id_kategori_produk" id="id_kategori_produk" class="form-control select2" data-placeholder="{{ __('Pilih Kategori') }}" data-minimum-results-for-search="Infinity">
                                        ...
                                        <div class="col-md-3">
                                            <select name="id_satuan" id="id_satuan" class="form-control select2" data-placeholder="{{ __('Pilih Satuan') }}" data-minimum-results-for-search="Infinity">
...
{{--                                        </div>--}}
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select name="berat_satuan" id="berat_satuan" class="form-control select2" data-placeholder="{{ __('Pilih Berat Satuan') }}" data-minimum-results-for-search="Infinity">
...
{{--                                        </div>--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="gambar" id="gambar" onchange="showPreview(event);">
                                                <label class="custom-file-label" id="label_gambar">Upload Gambar Produk</label>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select id="akun_pembelian" name="akun_pembelian" class="form-control select2" data-placeholder="{{ __('Pilih Akun Pembelian') }}">
                                                    <option >{{ __('Pilih Akun Pembelian') }}</option>
                                                    @foreach ($akun as $gl)
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label form-label" for="pajak_penjualan">{{ __('Pajak Jual') }}<span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-3">
...
{{--                                                           style="text-align: right;"--}}
{{--                                                           id="harga_jual_amount"--}}
{{--                                                           name="harga_jual_amount"--}}
{{--                                                           aria-label="Amount (to the nearest dollar)">--}}
...
{{--        select2--}}
        ...
        $('#harga_jual_amount').on('keyup',function(){
            $('#harga_jual_amount').mask("#,##0", {reverse: true});
            test_value = $(this).val().replace(/[^0-9]+/g, "");
            $('#harga_jual').val(test_value)
        })
