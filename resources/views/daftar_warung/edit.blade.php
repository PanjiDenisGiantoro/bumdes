                ...
                <form method="POST" id="warung_form" class="form-horizontal" action="{{ !empty($daftar_warung->id) ? route('daftar_warung.update', [$daftar_warung->id]) : route('daftar_warung.create') }}"enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label class="control-label form-label" for="id_anggota">{{ __('Nama Anggota') }}<span class="text-red">*</span></label>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            <input
                                                value="{{ date('Y-m-d', strtotime($daftar_warung->anggota->tanggal_lahir)) ??''}}"
                                                id="tanggal"
                                                name="tanggal"
                                                type="date"
                                                maxlength="10"
                                                style="width: 95%"
                                                @class(['required', 'form-control', 'is-invalid' => $errors->has('tanggal')])
                                            readonly
                                            />
                                            @error('tanggal_lahir')
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="control-label form-label" for="nama_warung">{{ __('Nama Usaha') }}<span class="text-red">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <input
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="control-label form-label" for="nama_jalan">{{ __('Alamat Usaha sama dengan Anggota') }}<span class="text-red">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <label class="switch">
                        ...
                        <div class="form-group clearfix" id="i">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label form-label" for="no_rumah">{{ __('Nomor') }}<span class="text-red">*</span></label>
                                </div>
                                <div class="col-md-3">
                                    <input
                        ...
                        <div class="form-group clearfix" id="iii">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    @php
                                        $cities = \Indonesia::findProvince($daftar_warung->provinsi, ['cities']);
                        ...
                        <div class="form-group clearfix" id="iiiiii">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <input type="text"onkeypress="return isNumberKey(event)"  name="kodepos" class="form-control" value="{{ $daftar_warung->kodepos ?? '' }}"
                                    >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4">
                                    <select name="wilayah" id="wilayah" class="form-control" >
                                        ...
                                        @foreach($wilayah as $wilayahs)
                                            <option value="{{$wilayahs->id}}"@if($daftar_warung->wilayah == $wilayahs->id) selected @endif >{{$wilayahs->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> --}}
                        ...
                        <div class="form-group clearfix" id="iiiii">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="control-label form-label" for="bidang_usaha">{{ __('Bidang Usaha') }}<span class="text-red">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <select id="bidang_usaha" name="bidang_usaha" class="form-control select2" data-placeholder="{{ __('Pilih Bidang Usaha') }}">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label form-label" for="berdiri_sejak">{{ __('Berdiri Sejak') }}<span class="text-red">*</span></label>
                                </div>
                                <div class="col-md-3">
                                    <input
...
@enderror
                        ...
                        <br>
                        <h3 class="card-title">{{ __('Upload Gambar Usaha')}}  <span style="font-size:12px">JPG / PNG</span><span class="text-red">*</span></h3>
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="file" class="custom-file-input" name="file_fktp2" id="file_fktp2"onchange="showPreview2(event);">
                        ...
                        <div class="form-group clearfix">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="file" class="custom-file-input" name="file_fktp3" id="file_fktp3"onchange="showPreview3(event);">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="file" class="custom-file-input" name="file_fktp4" id="file_fktp4"onchange="showPreview4(event);">
                                ...
                                <div class="col-md-6">
                                    <label class="switch">
                                        <input type="checkbox" data-toggle="toggle" id="aktif" name="ao"
                                               ...
                                               @if($daftar_warung->status_aktif == 1) checked @endif>
                    ...
                    <div class="card-footer border border-top-0 text-right">
                        ...
                        <a href="#" class="btn btn-primary"  data-toggle="modal" data-target="#confirmationModal"  id="submit_btn">{{ __('Perbarui') }}</a>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p style="text-align: center;font-size: 15px">Adakah Anda Ingin Melanjutkan Proses Ini ? </p>
                    <div class="text-center">
                        <a href="#" class="btn btn-md btn-primary mr-3" id="deleteBtn4">
                            Lanjutkan
                        </a>
                        <a data-dismiss="modal" href="#" class="btn btn-md btn-danger">
                            Tidak
...
$(".nominal").inputmask('decimal', {
    ...
    document.getElementById("berdiri_sejak").setAttribute("max", today);
        ...
        var pengeluaran1 = document.forms["warung_form"]["pengeluaran1"];
