...
<body class="bg-white">
    ...
    <htmlpageheader name="pageHeader">
        <div class="header-border">
            ...
            <h5 class="report-title"><strong>{{ 'Delivery Order' }}</strong></h5>
        </div>
        ...
        <table border="1" cellpadding="0" cellcollapse="collapse">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col" style="white-space: nowrap;">
                        <span class="sub-text">Berat</span>
                    </th>
                    <th class="nk-tb-col">
                        <span class="sub-text">Jumlah Berat</span>
                    </th>
                    <th class="nk-tb-col">
            ...
            <tbody>
                ...
                <tr class="nk-tb-item">
                    <td rowspan="2" colspan="4">&nbsp; Total berat : </td>
                </tr>
                <tr class="nk-tb-item">
                    <td class="text-center" style="font-weight: bold; color:black;" colspan="2">&nbsp; Perhatian</td>
                </tr>
                <tr class="nk-tb-item">
                    <td rowspan="4" colspan="4">&nbsp; Catatan: </td>
                </tr>
                <tr class="nk-tb-item">
                    <td class="nk-tb-col text-center" style="color:black;" colspan="2">&nbsp; 1. surat jalan ini merupakan bukti resmi penerimaan barang</td>
                </tr>
                <tr class="nk-tb-item">
                    <td class="nk-tb-col text-center" style="color:black;" colspan="2">&nbsp; 2. Surat jalan ini bukan bukti penjualan</td>
                </tr>
                <tr class="nk-tb-item">
                    <td class="nk-tb-col text-center" style="color:black;" colspan="2">&nbsp; 3. Surat jalan ini akan dilengkapi invoice sebagai bukti penjualan</td>
                </tr>
            </tbody>
        </table>
    </div>
    <div>
        <p style="font-size: 10px; padding-left: 10px; color:black;">BARANG SUDAH DITERIMA DALAM KEADAAN BAIK DAN CUKUP oleh:</p>
        <p style="padding-left: 10px; color:black; font-size: 9.8px; padding-top: -10px;">(tandan tangan dan cap (stempel) koperasi</p>
    </div>
    <div class="text-admin">
        <h5 style="padding:40px; ">Pengirim</h5>
        <h5 style="text-align:right; padding-top: -80px; padding-right: 40px;">Admin</h5>
    </div>
</body>
</html>
