        ...
        <div class="col-md-12">
            <div class="card m-b-20">
                <div class="card-header">
                    <h3 class="card-title">Lihat Pembayaran</h3>
                                ...
                                <div class="form-group" >
                                    ...
                                    <select name="no_penawaran" id="penawaran" class="form-control" disabled>
                                        ...
                                        @foreach($penjualan as $penjualans)
                                            <option value="{{$penjualans->id}}"@if($penjualans->id == $enjualan->no_pemesanan ?? '') selected @endif >{{$penjualans->no_pemesanan}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-group" >
                                    ...
                                    <input type="date" class="form-control" id="tanggal_penerimaan" name="tanggal_pemesanan"readonly
{{--                                           value tanggal_pengiriman format strtotime--}}

                                            value="{{\Carbon\Carbon::parse($enjualan->tanggal_pengiriman ?? '')->format('Y-m-d') ?? ''}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="form-group" >
                                    ...
                                    <input type="text" class="form-control" id="no_pesanan" name="no_pemesanan"
                                           value="{{$enjualan->no_pengiriman ?? ''}}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6" id="termin3">
                                <div class="form-group" >
                                    <label class="form-label" for="exampleInputEmail1">Termin</label>
                                    <input type="text" id="terminn" name="termin_pemesanan"  class="form-control" readonly value="{{$enjualan->pemesanans->termins->nama_termin_penjualan ?? ''}}">
                            ...
                            <table class="table card-table table-center text-nowrap table-primary" width="100%" id="table">
                                ...
                                @foreach($enjualanbody as $kode)
                                    <tr>
                                        ...
                                        <td>{{$kode->produk->kode_produk}}</td>
                                        <td>{{$kode->produk->satuan->satuan_produk}}</td>
                                        <td>{{$kode->qty}}</td>
                                        <td>{{number_format($kode->harga_produk)}}</td>
                                            ...
                                            @else
                                                ...
                                                <td>{{$kode->diskon}} %</td>
                                                @endif
                                        <td>{{$kode->pajaks->nama_pajak ?? ''}}</td>
                                        <td>{{number_format($kode->total)}}</td>
                                    </tr>

                                    @php $j += $kode->total@endphp
                                @endforeach
                                </tbody>
                            </table>
                        </div>
...
{{--                        </div>--}}
                        ...
                        <div class="form-horizontal " id="moreTwo">
                            <div class="form-group " id="pajak_seluruh">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <h5 style="font-size: 12px">Rp.{{number_format($j),2 ?? ''}}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group " id="pajak_seluruh">
                            ...
                            <div class="form-group " id="pajak_seluruh">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        @php $ok = $enjualan->total - $enjualan->biaya_pengiriman;
                                                $diskon = $ok * $enjualan->diskontotal / 100;
                                        @endphp
                            ...
                            <div class="form-group " id="diskon_group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <h5 style="font-size: 12px">Rp.@if($enjualan->biaya_pengiriman != ''||$enjualan->biaya_pengiriman != 0){{number_format($enjualan->biaya_pengiriman )}} @else - @endif</h5>
                                    </div>
                        ...
                        <div class="form-group ">
                            <div class="row">
                                <div class="col-md-9">
                                    <label style="float: right" class="form-label" id="examplenameInputname2">Total</label>
                                </div>
                        ...
                        <div class="form-group ">
                            <div class="row">
                                <div class="col-md-9">
                                    <label style="float: right" class="form-label" id="examplenameInputname2">Sisa Tagihan</label>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-2 ">
                                    <h5><b class="balance mt-5"></b></h5>
                                    <h5 style="font-size: 12px">Rp.{{number_format($enjualan->sisa_tagihan ?? ''),2}}</h5>
                                    <input type="text"  id="total1" name="total1"  class="total1 form-control" hidden >
                                </div>
                            </div>
                        </div>
