                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" id="simpanan_ada_ao" name="ao" data-toggle="toggle"
                                           ...
                                           data-offstyle="dark"
                                         @if($enjualan->ada_pemesanan ?? '' == 1) checked @endif disabled>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group col-md-6">
                                <div class="form-group" >
                                    ...
                                    <input type="date" class="form-control" id="tanggal_penerimaan" name="tanggal_pemesanan"readonly value="{{$enjualan->tanggal_pengiriman ?? ''}}">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="form-group" >
                        ...
                        <div class="form-horizontal " id="moreTwo">
                            ...
                            <div class="form-group " id="diskon_group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <h5 style="font-size: 12px">Rp.{{number_format($enjualan->biaya_pengiriman ?? ''),2}}</h5>
                                    </div>
