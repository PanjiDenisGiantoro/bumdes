    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-10">
            <div class="card border-0 m-b-20">
                ...
                <form id="form_pembiayaan" autocomplete="off" method="POST" class="form-horizontal" action="{{ !empty($rekening->id) ? route('rekening-pembiayaan.update', [$rekening]) : route('rekening-pembiayaan.store') }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <label class="control-label form-label" for="anggota_id">{{ __('Anggota') }}<span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="control-label form-label" for="produk_id">{{ __('Produk') }}<span
                                                    class="text-danger">*</span></label>
                                            <select id="produk_id" name="produk_id" class="form-control select2"  {{ !empty($rekening) ? 'disabled' : ''}} required>
                                                <option value="">&nbsp;</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <!-- <div class="form-group clearfix">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="control-label form-label" for="sumber_dana">{{ __('Sumber Pengembalian') }}<span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="control-label form-label" for="ao">{{ __('Akun Officer') }}</label>
                                            <select class="form-select" name="ao_id" id="ao_id" data-placeholder="Pilih AO.." data-minimum-results-for-search="10" data-allow-clear="true" data-search="true" data-ajax--url="{{ route('akun-officer.index') }}" data-ajax--data-type="json"
                                                {{ Route::getCurrentRoute()->getName() == 'rekening-pembiayaan.approve' ? 'disabled' : ''}}>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body mt-3 b-0 mb-0">
                                            ...
                                            <ul class="list-inline mb-0">
                                                <li class="previous list-inline-item">
                                                    <a id="hitung_btn" disabled class="btn btn-primary" style="color:white" >Hitung</a>
                                                    <a id="reset_btn" disabled class="btn btn-danger" style="color:white" >Reset</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="clearfix form-group">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        ...
                                                        <select name="rek_autodebet" id="rek_autodebet" data-placeholder="Autodebet Angsuran.." class="form-control" data-allow-clear="true" 
                                                            {{ Route::getCurrentRoute()->getName() == 'rekening-pembiayaan.approve' ? 'disabled' : '' }}>
                                                            <option value=""></option>
                                                        </select>
                                                    </div>
                    ...
                    @if (Route::getCurrentRoute()->getName() == 'rekening-pembiayaan.approve')
                                ...
                                <div class="invoice-bills">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <a id="jadwalModal_cancel_btn" class="btn btn-danger mb-5" style="color: white">{{ __('Tutup') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center">
                        <a href="#" class="btn btn-md btn-primary mr-3" id="confirmModal_submit_btn">
                            Lanjutkan
                        </a>
...
@push('scripts')
    ...
    <script>
        ...
        var availableAutodebetRekening = '';
        ...
        $(document).ready(function(){
            ...
            $('#anggota_id').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            // console.log("ARRAVE");
                            // console.log("data :" + JSON.stringify(response.results))
                            $('#nik').val(response.results.nik);
                            $('#no_mitra').val(response.results.no_mitra);

                            getRekeningAutodebet(response.results.id);
                        }
                    },
                });
            });
            ...
            $('#approve_btn').on('click', function(e) {
                e.preventDefault();
                $('#status_value').val('{{ \App\Models\RekeningPembiayaan::STATUS_APPROVED }}');
        ...
        function getRekeningAutodebet(id) {
            ...
            if(id) {
                $.ajax({
                    ...
                    success: function(response) {
                        if (response) {
                            availableAutodebetRekening = response.results;

                            // Custom function for custom condition - Arrave
                            if ('{{ !empty($rekening->id) }}') {
                                let res = availableAutodebetRekening.map((rekening, i) => {
                                    return {
                                        id: rekening.id,
                                ...
                                $('#rek_autodebet').empty().select2({
                                    data: res,
                                });

                                $('#rek_autodebet').val('{{ !empty($rekening->rekAutodebet) ? $rekening->rekAutodebet->id : "" }}').change();
                            }
        ...
        function controlAkadFormField(selectedAkad) {
            ...
            if (selectedAkad == 'murabahah' || selectedAkad == 'imbt') {
                ...
                $("label[for='harga_akhir']").text('Harga Pokok Akhir');
            ...
            // Set Rekening autodebet on dropdown
            if (availableAutodebetRekening != '') {
                let res = availableAutodebetRekening.map((rekening, i) => {
                    return {
                        id: rekening.id,
                        text: rekening.no_akun + ' - ' + rekening.produk.nama_simpanan,
    ...
    @if (!empty($rekening) && $rekening->anggota->id)
        <script>
            $(document).ready(function () {
                ...
                $('#form_pembiayaan input').attr('readonly', 'readonly');
                $('#reset_btn').prop("onclick", null).off("click");
            ...
            $('#confirmModal_submit_btn').on('click', function() {
                ...
                var tujuan_pengajuan = document.forms["form_pembiayaan"]["tujuan_pengajuan"];
                var sumber_dana = document.forms["form_pembiayaan"]["sumber_dana"];
        ...
        <script>
            $('#confirmModal_submit_btn').on('click', function() {
                ...
                var anggota_id = document.forms["form_pembiayaan"]["anggota_id"];
                var pilihan_akad = document.forms["form_pembiayaan"]["pilihan_akad"];
                var produk_id = document.forms["form_pembiayaan"]["produk_id"];
                var tujuan_pengajuan = document.forms["form_pembiayaan"]["tujuan_pengajuan"];
                var sumber_dana = document.forms["form_pembiayaan"]["sumber_dana"];
