                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="control-label form-label" for="tujuan_pengajuan">{{ __('Agunan') }}</label>
                                            <select id="id_agunan" name="id_agunan" class="form-select" data-placeholder="Pilih agunan..." data-allow-clear="true" required>
                                                <option value="">&nbsp;</option>
                                                @foreach($agunan as $data)
                                                    <option value="{{$data->id}}">{{$data->nama_agunan}}</option>
                                                @endforeach
                                            </select>
                                        </div>
{{--                                        <div class="col-md-6">--}}
{{--                                            <label class="control-label form-label" for="sumber_dana">{{ __('Akun Officer') }}</label>--}}
{{--                                            <select id="ao" name="ao" class="form-control select2" data-placeholder="Pilih sumber..." data-allow-clear="true" required>--}}
{{--                                                <option value="">&nbsp;</option>--}}
{{--                                                @foreach($daftarAO as $i => $ao)--}}
{{--                                                    <option value="{{$ao->id}}">{{$ao->nama_pegawai}}</option>--}}
{{--                                                @endforeach--}}
{{--                                            </select>--}}
{{--                                        </div>--}}
                                    </div>
                                ...
                                <div class="clearfix form-group">
                                    <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <select name="angsuran_auto_debet_simpanan" id="angsuran_auto_debet_simpanan" class="form-control" placeholder="Pilih Angsuran Auto Debet ...">

                                                <option value="">Pilih Rekening angsuran auto debet ...</option>
                            ...
                            <div class="col-lg-12">
                                <div class="invoice-bills">
                                    <div class="table-responsive">
                                        ...
                                        <a id="jadwalModal_kirim_btn"  class="btn btn-primary mb-5" style="color: white">{{ __('Kirim ') }}</a>
...
<script>
    ...
    function controlAkadFormField(selectedAkad) {
        ...
        if (selectedAkad == 'murabahah' || selectedAkad == 'imbt') {
            ...
            $("label[for='harga_akhir']").text('Harga Setelah  Uang Muka');
