...
@section('breadcrumb')
<x-breadcrumb title="{{ __('Buku Besar') }}">
        ...
        <div class="card">
            ...
            <table class="table" style="width: 100%">
                ...
                <tbody>
                    @foreach ($akun as $a)
                    <tr>
                        <td class="font-weight-bold text-uppercase" colspan="6">
                            {{ $a->nama }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            {{ $entry->ledger->date ?? null }}
                        </td>
                        <td>
                            {{ $entry->ledger->journal_number ?? null }}
                        </td>
                        <td>
                            {{ $entry->ledger->description ?? null }}
                        </td>
                        <td class="text-right">
                            {{ $entry->debit ? number_format($entry->amount, 2) : null }}
                        </td>
                        <td class="text-right">
                            {{ $entry->credit ? number_format($entry->amount, 2) : null }}
                        </td>
                        <td class="text-right">
                            {{ $entry->current_balance ? number_format($entry->current_balance, 2) : '0.00' }}
                        </td>
                    </tr>
                    @endforeach
                    <tr class="table-active">
                        ...
                        <th class="font-weight-bold text-right">
                            {{ $a->total_debit ? number_format($a->total_debit, 2) : null }}
                        </th>
                        <th class="font-weight-bold text-right">
                            {{ $a->total_credit ? number_format($a->total_credit, 2) : null }}
                        </th>
                        <th>
