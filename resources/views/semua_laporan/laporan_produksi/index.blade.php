...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Laporan Produksi') }}">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>LAPORAN PRODUKSI</b></h3>
                ...
                <div class="card-tools ">
                    <table class="table  table-vcenter  table-primary" >
                        ...
                        <tr >
                            ...
                            <th class="text-white">Produk Jadi</th>
                            <th class="text-white">Kuantitas</th>
                            <th class="text-white">HPP</th>
                            <th class="text-white">Tanggal</th>
                            <th class="text-white">Nomor</th>
                            <th class="text-white">Gudang</th>
                        </tr>
                        </thead>
                        <tbody>
