...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Pendapatan Per Perlanggan') }}">
        <li class="breadcrumb-item">
            <a href="{{ route('semua_laporan.index') }}">{{ __('Laporan') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ __('Pendapatan Per Perlanggan') }}
        </li>
    </x-breadcrumb>
@endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>PENDAPATAN PER PELANGGAN</b></h3>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('#customers-table1').DataTable({
            ...
            ajax: '{{ route('pendapatan_per_pelanggan.create') }}',
            columns: [
                {
