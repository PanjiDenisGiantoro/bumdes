...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Pengiriman Per Produk') }}">
        <li class="breadcrumb-item">
            <a href="{{ route('semua_laporan.index') }}">{{ __('Laporan') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ __('Pengiriman Per Produk') }}
        </li>
    </x-breadcrumb>
@endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>PENGIRIMAN PER PRODUK</b></h3>
                ...
                <div class="card-tools ">
                    <table class="table  table-vcenter  table-primary" >
                        ...
                        <tr bgcolor="white" style="height: 30%">
                            ...
                            <th><strong>Rp.100.000</strong></th>
                        </tr>
                        </tbody>
                    </table>
                </div>
