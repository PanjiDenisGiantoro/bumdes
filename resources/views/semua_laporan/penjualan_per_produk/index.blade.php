...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Penjualan Per Produk') }}">
        <li class="breadcrumb-item">
            <a href="{{ route('semua_laporan.index') }}">{{ __('Laporan') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ __('Penjualan Per Produk') }}
        </li>
    </x-breadcrumb>
@endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>PENJUALAN PER PRODUK</b></h3>
                    ...
                    <div class="col-12">
                        <table class=" table card-table table-vcenter text-nowrap table-primary" id="customers-table1"style="width: 100%">
                            ...
                            <tr>
                                ...
                                <th class="text-white">Jumlah Terjual</th>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('#customers-table1').DataTable({
            ...
            ajax: '{{ route('penjualan_per_produk.create') }}',
            columns: [
                {
                ...
                { data: 'jumlah_qty', name: 'jumlah_qty' },
