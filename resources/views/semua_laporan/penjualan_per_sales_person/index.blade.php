...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Penjualan Per Sales Person') }}">
        <li class="breadcrumb-item">
            <a href="{{ route('semua_laporan.index') }}">{{ __('Laporan') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ __('Penjualan Per Sales Person') }}
        </li>
    </x-breadcrumb>
@endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>PENJUALAN PER SALES PERSON</b></h3>
                ...
                <div class="card-tools ">
                    <table class="table card-table table-vcenter text-nowrap table-primary" >
                        ...
                        <tr >
                            ...
                            <th class="text-white">Nama Sales</th>
                            <th class="text-white">Jumlah Penjualan</th>
                            <th class="text-white">Total Penjualan</th>
                            <th class="text-white">Insentif Sales</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
