...
@section('breadcrumb')
    <x-breadcrumb title="{{ __('Ringkasan Stok Gudang') }}">
        <li class="breadcrumb-item">
            <a href="{{ route('semua_laporan.index') }}">{{ __('Laporan') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ __('Ringkasan Stok Gudang') }}
        </li>
    </x-breadcrumb>
@endsection
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title w-65" ><b>RINGKASAN STOK GUDANG</b></h3>
                ...
                <div class="card-tools ">
                    <table class="table  table-vcenter  table-primary" >
                        ...
                        <tr >
                            ...
                            <th class="text-white">Qty Awal</th>
                            <th class="text-white">Pergerakan Qty</th>
                            <th class="text-white">Qty Akhir</th>
                        </tr>
                        </thead>
                        <tbody>
