            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                        <tr>
                            @foreach ($TipeKontak as $i => $kode)
                                <td class="col-lg-none">{{ $TipeKontak->firstItem() + $i }}</td>
                                <td>{{$kode->tipe_kontak ?? ''}}</td>
                                ...
                                <td class="actions">
                                        ...
                                        <li><a href="{{ route('tipe_kontak.edit', $kode->id) }}"
                        ...
                        <div class="modal fade zoom" tabindex="-1" id="deleteonModal1{{$kode->id}}">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('tipe_kontak.destroy',$kode->id)}}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
