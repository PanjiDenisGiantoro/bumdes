...
{{--                            <a href="#"><img style="height: 40px" src="https://www.smik.id/wp-content/uploads/2020/06/SMIK-TopLogoNonTransparent-01-1.png" alt="logo"></a>--}}
                            <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Kowargi <a href="https://dagangbareng.id/login">Dagangbareng.id</a></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 30px 30px 20px">
                            <p style="margin-bottom: 10px;">Hai {{ $user->name}},</p>
                            <p style="margin-bottom: 10px;">Berikut adalah Id dan  Password Anda.</p>
                            <p style="margin-bottom: 10px;">Silahkan Login <a href="https://dagangbareng.id/login"></a>dagangbareng.id</p>
                            <p style="margin-bottom: 10px;">
                                ID Pengguna: <code>{{ $user->id }}</code> atau <code>{{ $user->email }}</code>
                                <br>
                                Password: <code>{{$password_user }}</code>
                            </p>
                        </td>
                    </tr>
                    </tbody>
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding:25px 20px 0;">
                            <!-- <p style="font-size: 13px;">Copyright © 2020 DashLite. All rights reserved. <br> Template Made By <a style="color: #6576ff; text-decoration:none;" href="https://themeforest.net/user/softnio/portfolio">Softnio</a>. -->
                            </p>
