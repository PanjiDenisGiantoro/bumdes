            ...
            <div class="card">
                ...
                <a href="{{ route('tetapan.index') }}" class="btn btn-primary" style="background-color: red">{{ __('Kembali') }}</a>
                    <div class="card-options">
                        ...
                        <a style="background-color: blue" href="{{ route('agunan.create') }}">
                            <button class="btn btn-primary">Tambah Agunan</button>
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tr>
                            @foreach ($agunan as $i => $kode)
                                ...
                                <td class="actions">
                                        ...
                                        <li><a href="{{route('agunan.edit',$kode->id)}}"
                        ...
                        <div class="modal fade zoom" tabindex="-1" id="deleteonModal1{{$kode->id}}">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('agunan.destroy',$kode->id)}}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
