...
<br>
    <!-- <x-breadcrumb title="{{ __('Daftar Unit Kerja') }}">
            ...
            <div class="card">
                ...
                <a href="{{ route('tetapan.index') }}" class="btn btn-primary" style="background-color: red">{{ __('Kembali') }}</a>
                    <div class="card-options">
                        <a style="background-color: blue" href="{{ route('kode_pengguna.create') }}">
                            <button class="btn btn-primary">Tambah Unit Kerja</button>
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tr>
                            @foreach ($KodePengguna as $i => $kode)
                                ...
                                <td class="actions">
                                        ...
                                        <li><a href="{{route('kode_pengguna.edit',$kode->id)}}"
                        ...
                        <div class="modal fade zoom" tabindex="-1" id="deleteonModal1{{$kode->id}}">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('kode_pengguna.destroy',$kode->id)}}" method="POST" class="d-inline">
