            ...
            <div class="card">
                ...
                <a href="{{ route('tetapan.index') }}" class="btn btn-primary" style="background-color: red">{{ __('Kembali') }}</a>
                    <div class="card-options">
                        ...
                        <a  style="background-color: blue" href="{{ route('pengurusan.create') }}">
                            <button class="btn btn-primary">Tambah Pengurusan</button>
                        </a>
                    </div>
                </div>
                         ...
                         @foreach($pengurusan as $kode)
                            <tr>
                                ...
                                {{-- <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <li><a href="{{route('pengurusan.edit',$kode->id)}}"
                                ...
                                <td class="actions">
                                        ...
                                        <li><a  href="{{ route('pengurusan.edit',$kode->id) }}" ><i class="fa fa-pencil"></i>&nbsp;&nbsp; Edit</a></li>
                            ...
                            <div class="modal fade zoom" tabindex="-1" id="deleteonModal1{{$kode->id}}">
                                <div class="modal-dialog" role="document">
                                    <form action="{{route('pengurusan.destroy',$kode->id)}}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
