            ...
            <div class="card">
                ...
                <a href="{{ route('tetapan.index') }}" class="btn btn-primary" style="background-color: red">{{ __('Kembali') }}</a>
                    <div class="card-options">
                        ...
                        <a style="background-color: blue" href="{{ route('template_wa.create') }}">
                            <button class="btn btn-primary">Tambah Template Whatsapp</button>
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table mb-0">
                        ...
                        <tr>
                            @foreach ($templatewa as $i => $kode)
                                ...
                                <td>{{$kode->template_watsapp ?? ''}}</td>
                                <td>{{$kode->keterangan_watsapp ?? ''}}</td>
                                <td class="action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <li><a href="{{route('template_wa.edit',$kode->id)}}"
                        ...
                        <div class="modal fade zoom" tabindex="-1" id="deleteonModal1{{$kode->id}}">
                            <div class="modal-dialog" role="document">
                                <form action="{{route('template_wa.destroy',$kode->id)}}" method="POST" class="d-inline">
                                    @method('delete')
                                    @csrf
